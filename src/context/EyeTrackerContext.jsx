...
export const EyeTrackerProvider = ({ children }) => {
            ...
            wg.setGazeListener((data, clock) => {
                if (data) {
                    ...
                    if (now - lastUpdateRef.current > 16) {
                        ...
                        setGaze(prev => {
                            const alpha = 0.4; // Increased Alpha for better responsiveness (was 0.08)
                            return {
    ...
    useEffect(() => {
        ...
        if (!document.getElementById(styleId)) {
            ...
            style.id = styleId;
            // logic: Hide GazeDot and Video based on body classes
            style.innerHTML = `
            ...
            body.hide-webgazer-video #webgazerVideoFeed, 
            body.hide-webgazer-video #webgazerVideoCanvas, 
            body.hide-webgazer-video #webgazerFaceOverlay, 
            body.hide-webgazer-video #webgazerFaceFeedbackBox,
            body.hide-webgazer-video #webgazerVideoContainer {
                display: none !important;
                opacity: 0 !important;
                pointer-events: none !important;
            }
        ...
        if (isCalibrating) {
            ...
            document.body.classList.remove('hide-webgazer-video');
            ...
            document.body.classList.add('hide-webgazer-video');
